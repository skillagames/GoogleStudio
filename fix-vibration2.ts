...
const newStart = 
  ...
  '                      <div className="flex items-center justify-between mb-3">\\n' +
  '                         <h5 className="text-[8px] font-bold text-slate-400 uppercase tracking-widest">Vibration Diagnostics</h5>';
...
console.log("Successfully ran replacements", content.includes("isAndroidDebugExpanded"));
